...
import {
  ...
  readPrototypeOrigin,
  type ReviewEmbedOrigin,
} from "./prototype-origin-response"
import { ReviewShell } from "./review-shell"

// Re-exported so every existing import of these two names from `"./page"`
// (including `page.test.ts`) needs no edit — see `prototype-origin-response.ts`'s
// own doc comment for why the implementation moved there.
export { readPrototypeOrigin, type ReviewEmbedOrigin }
